from config import client, index, db_config, infra_types, infra_detail_questions, property_feature_questions
...
def main():
    ...
    chatbot = RealEstateChatbot(client, index, db_config)
