...
class Config:
    ...
    JWT_SECRET = os.getenv("JWT_SECRET", "c784167e8eef4fcbe6f1a01fba80d648f2c8835c18d18f453d9484e785122faf")
    JWT_ALGORITHM = os.getenv("JWT_ALGORITHM", "HS256")
    JWT_EXPIRATION = int(os.getenv("JWT_EXPIRATION", "86400")) # 24시간으로 변경
    JWT_ACCESS_TOKEN_EXPIRES = timedelta(seconds=JWT_EXPIRATION)
    ...
    VITE_GEOAPIFY_API_KEY = os.getenv("VITE_GEOAPIFY_API_KEY")
    
    # 데이터베이스 연결 설정 (직접 psycopg2 연결용)
    DB_CONFIG = {
